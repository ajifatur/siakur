...
<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah KKM</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.kkm.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select name="mapel" class="form-select form-select-sm {{ $errors->has('mapel') ? 'border-danger' : '' }}">
                                <option value="" disabled selected>--Pilih--</option>
                                @foreach($mapel as $m)
                                <option value="{{ $m->id }}" {{ old('mapel') == $m->id ? 'selected' : '' }}>{{ $m->nama }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('mapel'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenis-1" value="1" {{ old('jenis') == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="jenis-1">
                                    Pengetahuan
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis" id="jenis-2" value="2" {{ old('jenis') == '2' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="number" name="kkm" class="form-control form-control-sm score {{ $errors->has('kkm') ? 'border-danger' : '' }}" value="{{ old('kkm') }}">
                            @if($errors->has('kkm'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="deskripsi_a" class="form-control form-control-sm {{ $errors->has('deskripsi_a') ? 'border-danger' : '' }}" rows="3">{{ old('deskripsi_a') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="deskripsi_b" class="form-control form-control-sm {{ $errors->has('deskripsi_b') ? 'border-danger' : '' }}" rows="3">{{ old('deskripsi_b') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="deskripsi_c" class="form-control form-control-sm {{ $errors->has('deskripsi_c') ? 'border-danger' : '' }}" rows="3">{{ old('deskripsi_c') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="deskripsi_d" class="form-control form-control-sm {{ $errors->has('deskripsi_d') ? 'border-danger' : '' }}" rows="3">{{ old('deskripsi_d') }}</textarea>
