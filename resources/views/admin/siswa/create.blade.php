            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin.siswa.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="nomor_identitas" class="form-control form-control-sm {{ $errors->has('nomor_identitas') ? 'border-danger' : '' }}" value="{{ old('nomor_identitas') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jenis_kelamin" id="gender-{{ $gender['key'] }}" value="{{ $gender['key'] }}" {{ old('jenis_kelamin') == $gender['key'] ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="tempat_lahir" class="form-control form-control-sm {{ $errors->has('tempat_lahir') ? 'border-danger' : '' }}" value="{{ old('tempat_lahir') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="input-group input-group-sm">
                                <input type="text" name="tanggal_lahir" class="form-control form-control-sm {{ $errors->has('tanggal_lahir') ? 'border-danger' : '' }}" value="{{ old('tanggal_lahir') }}" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input type="text" name="nomor_telepon" class="form-control form-control-sm {{ $errors->has('nomor_telepon') ? 'border-danger' : '' }}" value="{{ old('nomor_telepon') }}">
