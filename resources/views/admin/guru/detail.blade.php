...
<div class="row">
                ...
                <div class="d-flex justify-content-center text-center">
                    ...
                    @else
                        <div class="btn-avatar rounded-circle me-2 text-center bg-dark">
                            <div class="avatar-overlay"><i class="bi-camera"></i></div>
                            <h2 class="text-white" style="line-height: 150px; font-size: 75px;">{{ strtoupper(substr($guru->nama,0,1)) }}</h2>
                        </div>
                    @endif
                </div>
            </div>
    ...
    <div class="col-md-8 col-xl-9">
        ...
        @endif
        <div class="card">
            <div class="card-header"><h5 class="card-title mb-0">Profil Guru</h5></div>
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>NIS:</div>
                        <div>{{ $guru->nomor_identitas }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>Tanggal Lahir:</div>
                        <div>{{ date('d/m/Y', strtotime($guru->tanggal_lahir)) }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                    ...
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        ...
                        <div>{{ gender($guru->jenis_kelamin) }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>Nomor Telepon:</div>
                        <div>{{ $guru->nomor_telepon }}</div>
                    </li>
                    <li class="list-group-item px-0 py-1 d-sm-flex justify-content-between">
                        <div>Alamat:</div>
                        <div>{{ $guru->alamat }}</div>
