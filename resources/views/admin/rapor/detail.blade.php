...
@section('title', 'Atur Rapor')

@section('content')

@if($wali_kelas)
<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-2 mb-sm-0">Atur Rapor</h1>
</div>
@endif
<div class="row">
	<div class="col-12">
		<div class="card">
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('admin.rapor.store') }}">
                    @csrf
                    <input type="hidden" name="siswa_id" value="{{ $anggota_rombel->siswa_id }}">
                    <input type="hidden" name="rombel_id" value="{{ $anggota_rombel->rombel_id }}">
                    <div class="row mb-3">
                        <label class="col-lg-2 col-md-3 col-form-label">Predikat Sikap Spiritual <span class="text-danger">*</span></label>
                        <div class="col-lg-10 col-md-9">
                            <select name="sikap_spiritual_predikat" class="form-select form-select-sm {{ $errors->has('sikap_spiritual_predikat') ? 'border-danger' : '' }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="sikap_spiritual_deskripsi" class="form-control form-control-sm {{ $errors->has('sikap_spiritual_deskripsi') ? 'border-danger' : '' }}" rows="3">{{ $rapor ? $rapor->sikap_spiritual_deskripsi : '' }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select name="sikap_sosial_predikat" class="form-select form-select-sm {{ $errors->has('sikap_sosial_predikat') ? 'border-danger' : '' }}">
                                <option value="" disabled selected>--Pilih--</option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea name="sikap_sosial_deskripsi" class="form-control form-control-sm {{ $errors->has('sikap_sosial_deskripsi') ? 'border-danger' : '' }}" rows="3">{{ $rapor ? $rapor->sikap_sosial_deskripsi : '' }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select name="status" class="form-select form-select-sm {{ $errors->has('status') ? 'border-danger' : '' }}">
                                <option value="" disabled selected>--Pilih--</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-9">
                            ...
                            <a href="{{ route('admin.rapor.index') }}" class="btn btn-sm btn-secondary"><i class="bi-arrow-left me-1"></i> Kembali</a>
                        </div>
                    </div>
                </form>
            </div>
