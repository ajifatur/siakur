...
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('admin.tahun-akademik.update') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <select name="tahun" class="form-select form-select-sm {{ $errors->has('tahun') ? 'border-danger' : '' }}">
                                ...
                                <option value="{{ $y }}" {{ $tahun_akademik->tahun == $y ? 'selected' : '' }}>{{ $y.'/'.($y + 1) }}</option>
                                @endfor
                            </select>
                            @if($errors->has('tahun'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="semester" id="semester-1" value="1" {{ $tahun_akademik->semester == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="semester-1">
                                    Ganjil
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="semester" id="semester-2" value="2" {{ $tahun_akademik->semester == '2' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status-1" value="1" {{ $tahun_akademik->status == '1' ? 'checked' : '' }}>
                                <label class="form-check-label" for="status-1">
                                    Aktif
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status-0" value="0" {{ $tahun_akademik->status == '0' ? 'checked' : '' }}>
